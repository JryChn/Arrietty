...
networkmanager-qt ##desktop enviorment
#sway(waybar),sddm,fontawesome,zsh(oh-my-zsh),vimpython,fcitx,plymouth,ranger,fcitx-configtool,fcitx-rime
##working tools
#dev-vcs/git,curl,wget,tmux,rofi,trojan,qutebrowser,virt-manager,qemu,ovmf
libvirt firewall looking-glass ##other tools
...
clang layman -a thegreatmcpain sorrow gig gentoo-zh curl -sLf
